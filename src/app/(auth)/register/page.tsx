    ...
    <div className="gradient-mesh" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="card-elevated" style={{ width: "100%", maxWidth: 440, padding: 40 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: "var(--text-secondary)" }}>Start planning your dream trips with AI</p>
        </div>
        ...
        {success && (
          <div style={{ padding: "10px 14px", background: "rgba(16, 185, 129, 0.1)", color: "#10B981", borderRadius: 8, fontSize: 13, marginBottom: 20, border: "1px solid rgba(16, 185, 129, 0.2)" }}>
            Registration successful! Please check your email to verify. Redirecting to login...
          </div>
        )}

        {/* ... (Google button and Divider stays) ... */}
        <button style={{ width: "100%", padding: 12, borderRadius: "var(--radius)", border: "2px solid var(--border)", background: "var(--surface)", fontSize: 14, fontWeight: 500, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 20, fontFamily: "var(--font-body)" }}>
        ...
        <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input className="input" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" style={{ paddingLeft: 38 }} required />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input className="input" type={showPw ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min 8 characters" style={{ paddingLeft: 38, paddingRight: 38 }} required minLength={8} />
